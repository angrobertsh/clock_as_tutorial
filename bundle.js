...
var Clock3 = function (_React$Component) {
  _inherits(Clock3, _React$Component);
  ...
  function Clock3(props) {
    ...
    var _this = _possibleConstructorReturn(this, (Clock3.__proto__ || Object.getPrototypeOf(Clock3)).call(this, props));
    ...
    _this.parseString = _this.parseString.bind(_this);
    _this.padding = _this.padding.bind(_this);
    return _this;
  }
  ...
  _createClass(Clock3, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        null,
        this.parseString(),
        _react2.default.createElement(Clock12Hours, { state: this.state, dispatch: { padding: this.padding } })
      );
    }
  }]);
...
var Clock12Hours = function Clock12Hours(props) {
  return _react2.default.createElement(
    'div',
    null,
    props.state.hours % 12,
    ':',
    props.dispatch.padding(props.state.minutes),
    ':',
    props.dispatch.padding(props.state.seconds),
    ' ',
    props.state.hours >= 12 ? "PM" : "AM"
  );
};

document.addEventListener("DOMContentLoaded", function () {
  var root = document.getElementById("root");
  _reactDom2.default.render(_react2.default.createElement(Clock3, null), root);
});
